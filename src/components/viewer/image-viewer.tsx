  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-background text-foreground">
      ...
      <div className="relative mx-auto flex min-h-dvh w-full max-w-md flex-col justify-center px-4 py-5 sm:px-6 sm:py-8">
        <section className="overflow-hidden rounded-[2rem] border border-border/70 bg-card shadow-[0_24px_80px_-32px_rgba(15,23,42,0.45)]">
          {image.category === "music" ? (
            <div className="relative flex min-h-72 items-center overflow-hidden bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-700 px-5 py-10 text-white">
              <div
                aria-hidden="true"
            ...
            <div className="flex justify-center bg-muted/50 p-2 sm:p-3">
              <img
                src={`/api/${image.category}/images/${image.uid}/file`}
                alt={image.filename}
                className="block max-h-[78dvh] w-full rounded-md object-contain"
              />
            </div>
          )}
          ...
          <div className="space-y-5 p-5 sm:p-6">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-border/70 bg-muted/60 px-4 py-3.5">
              <CalendarClockIcon
            ...
            <Button
              asChild
              size="lg"
              className="h-12 w-full rounded-2xl bg-primary text-base font-semibold text-primary-foreground shadow-lg shadow-primary/20 hover:bg-primary/90"
            >
